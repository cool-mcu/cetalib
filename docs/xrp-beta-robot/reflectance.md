...
This module provides functions to interact with the LEFT OPTO and RIGHT OPTO reflectance sensors on the [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html).

<img src="../../assets/xrp-reflectance.png?raw=true"><br>

XRP Bets Controller RP2040 MCU GPIO Pin Connections:
* GP26/ADC0: LEFT OPTO sensor
* GP27/ADC1: RIGHT OPTO sensor
