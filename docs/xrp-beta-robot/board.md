...
This module provides functions to interact with the USER LED and USER SWITCH on the [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html).

<center>
<img src="../../assets/xrp-beta-board.jpg?raw=true">
</center><br>

XRP Beta Controller RP2040 MCU GPIO Pin Connections:
* USER LED: Uses the BUILTIN LED on the Pico W Board, connected to the WiFi Radio
* GP22: USER SWITCH
