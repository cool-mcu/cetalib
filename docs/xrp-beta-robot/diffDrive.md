...
The [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html) is a mobile robot platform where driving from one place to another is central to the design of any program. The "differential Drive" module makes driving easy.

**Note**: Although these motors contain shaft encoders, they are not currently used to control motor speed in these functions, so the robot will settle on an arbitrary speed (based on battery voltage, load conditions) given specific motor effort settings. 

<center>
<img src="../../assets/xrp-beta-diffDrive.jpg?raw=true"><br>
</center><br>
  
Simplified Motor/Encoder Schematic Diagram:
<center>
<img src="../../assets/xrp-beta-diffDrive-simplified-schematic.jpg?raw=true"><br>
</center><br>
