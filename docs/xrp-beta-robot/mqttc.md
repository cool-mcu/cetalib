...
This module provides functions to create and manage a **MQTT Client** connection on the [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html).

<center><img src="../../assets/xrp-beta-mqttc.png?raw=true"></center><br>
