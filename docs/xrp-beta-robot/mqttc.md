...
This module provides functions to interact with the WiFi/Bluetooth radio on the [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html). Specifically, this module provides an interface to utilize the WiFi interface to create **MQTT Client** network connections.

<center><img src="../../assets/xrp-beta-mqttc.jpg?raw=true"></center><br>
