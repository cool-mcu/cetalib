...
This module provides functions to read the Motor Shaft Encoder outputs on the [SparkFun XRP Beta Robot](https://www.sparkfun.com/experiential-robotics-platform-xrp-kit-beta.html). This information can be used to calculate the speed of the robot, how far it's travelled, or to control precisely the speed of the robot.
