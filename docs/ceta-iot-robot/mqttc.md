...
This module provides functions to create and manage a **MQTT Client** connection on the [CETA IoT Robot](https://www.cool-mcu.com/pages/robot-kit).

<center><img src="../../assets/ceta-iot-robot-mqttc.png?raw=true"></center><br>
